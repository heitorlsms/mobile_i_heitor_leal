...
const PlaceholderImage = require('../assets/images/background-photo.jpg');
    ...
    <GestureHandlerRootView style={styles.container}>
      ...
      {showAppOptions ? (
        ...
        <View style={styles.footerContainer}>
          <Button label="Choose the picture" theme="primary" onPress={pickImageAsync} />
          <Button label="Use this pic" theme="" onPress={() => setShowAppOptions(true)} />
        </View>
      )}
